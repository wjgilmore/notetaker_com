...
<div class="col-md-6">
{!! Form::model($book, array('method' => 'put', 'route' => ['books.update', $book->id], 'class' => 'form', 'novalidate' => 'novalidate')) !!}
    
<h2>Edit a Notebook</h2>
...
<div class="form-group">
    {!! Form::submit('Edit Notebook!', array('class'=>'btn btn-primary')) !!}
</div>
{!! Form::close() !!}
</div>
